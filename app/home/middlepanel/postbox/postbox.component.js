...
var PostBoxComponent = (function () {
    function PostBoxComponent(userService) {
    ...
    PostBoxComponent.prototype.deleteUser = function (id) {
        var _this = this;
        this.userService.delete(id).subscribe(function () { _this.loadAllUsers(); });
    };
    PostBoxComponent.prototype.loadAllUsers = function () {
        var _this = this;
