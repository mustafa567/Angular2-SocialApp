...
var LeftPanelComponent = (function () {
    function LeftPanelComponent(userService) {
    ...
    LeftPanelComponent.prototype.deleteUser = function (id) {
        var _this = this;
        this.userService.delete(id).subscribe(function () { _this.loadAllUsers(); });
    };
    LeftPanelComponent.prototype.loadAllUsers = function () {
        var _this = this;
